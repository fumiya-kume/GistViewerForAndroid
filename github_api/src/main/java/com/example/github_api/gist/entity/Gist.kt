...
data class Gist(
  ...
  @Json(name = "git_push_url") val gitPushUrl: String? = "",
  ...
  @Json(name = "html_url") val htmlUrl: String? = "http://github.com",
  @Json(name = "git_pull_url") val gitPullUrl: String? = "",
  @Json(name = "comments_url") val commentsUrl: String? = "",
  @Json(name = "files") val files: Map<String, File>,
...
data class File(
  ...
  @Json(name = "raw_url") val contentUrl: String?,
